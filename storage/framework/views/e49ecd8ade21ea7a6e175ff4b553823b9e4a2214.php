...
<head>
    ...
    <!-- bootstrap -->
    <link rel="stylesheet" href="<?php echo e(asset("storetheme/css/bootstrap.min.css")); ?> ">
    <!-- font-awesome -->
    <link rel="stylesheet" href=" <?php echo e(asset("storetheme/css/font-awesome.min.css")); ?>">
    <!-- custom -->
    <link rel="stylesheet" href="<?php echo e(asset("storetheme/css/templatemo-style.css")); ?>">
    <!-- google font -->
...
<div class="flexslider">
    <ul class="slides">
        <li>
            <img src="<?php echo e(asset("storetheme/images/slider-img1.jpg")); ?>" alt="Pizza Image 1">
        ...
        <li>
            <img src="<?php echo e(asset("storetheme/images/slider-img2.jpg")); ?>" alt="Pizza Image 2">
            <div class="flex-caption">
...
<section id="about" class="templatemo-section templatemo-top-130">
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-6 col-sm-6">
                <img src="<?php echo e(asset("storetheme/images/about-img1.jpg")); ?>" class="img-responsive img-bordered img-about" alt="about img">
            </div>
        </div>
    </div>
</section>
        ...
        <div class="row">
            ...
            <div class="col-md-4 col-sm-4">
                <div class="gallery-wrapper">
                    <img src="<?php echo e(asset("storetheme/images/gallery-img1.jpg")); ?>" class="img-responsive gallery-img" alt="Pizza 1">
            ...
            <div class="col-md-4 col-sm-4">
                <div class="gallery-wrapper">
                    <img src="<?php echo e(asset("storetheme/images/gallery-img2.jpg")); ?>" class="img-responsive gallery-img" alt="Pizza 2">
                    <div class="gallery-des">
                        <h3>Lorem ipsum</h3>
            ...
            <div class="col-md-4 col-sm-4">
                <div class="gallery-wrapper">
                    <img src="<?php echo e(asset("storetheme/images/gallery-img3.jpg")); ?>" class="img-responsive gallery-img" alt="Pizza 3">
                    <div class="gallery-des">
                        <h3>Pellentesque</h3>
            ...
            <div class="col-md-6 col-sm-6">
                <div class="gallery-wrapper">
                    <img src="<?php echo e(asset("storetheme/images/gallery-img4.jpg")); ?>" class="img-responsive gallery-img" alt="Pizza 4">
                    <div class="gallery-des">
                        <h3>Suspendisse</h3>
            ...
            <div class="col-md-6 col-sm-6">
                <div class="gallery-wrapper">
                    <img src="<?php echo e(asset("storetheme/images/gallery-img5.jpg")); ?>" class="img-responsive gallery-img" alt="Pizza 5">
                    <div class="gallery-des">
                        <h3>Elementum</h3>
                        <h5>Maecenas efficitur nisi id sapien</h5>
                    </div>
...
<script src="<?php echo e(asset("storetheme/js/jquery.js")); ?>"></script>

<script src="<?php echo e(asset("storetheme/js/bootstrap.min.js")); ?> "></script>
<script src="<?php echo e(asset("storetheme/js/plugins.js")); ?>"></script>
<script src="<?php echo e(asset("storetheme/js/smoothscroll.js")); ?>"></script>
<script src="<?php echo e(asset("storetheme/js/custom.js")); ?>"></script>

</body>
</html>
<?php /**PATH /home/javad/workspace/pizzaTask/resources/views/layouts/store.blade.php ENDPATH**/ ?>